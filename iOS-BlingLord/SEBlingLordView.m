 ...
 *
 * @param {CGRect} frame
 * @param {CGSize} itemSize
 * @param {CGSize} itemMargins
 * @param {CGSize} outerMargins
 * @param {NSMutableArray*} items
 *
 * @return {id}
 */
 ...
 * layoutStyle changes.
 *
 * @param {SEBlingLordLayoutStyle} layoutStyle
 * @return {void}
 */
         ...
         addObserverForName: SEBlingLordNotificationCloseView
                 ...
                 usingBlock: ^(NSNotification *note) {
                         ...
                         [UIView animateWithDuration:0.3f animations:^{
                               ...
                               for (SEBlingLordMenuItem *item in self.items) {
 ...
 *
 * @param {SEBlingLordMenuItem*} menuItem
 * @return {void}
 */
...
- (void) removeMenuItemAtIndex: (NSUInteger)idx
  ...
  if (animate) {
    ...
    [UIView animateWithDuration:0.2f animations: ^{
      ...
      [self layoutMenuItems]; // reposition the other items to fill the gap

    } completion:^(BOOL finished) {

      @strongify(self);
      [self setNeedsLayout]; // just in case
 ...
 *
 * @param {SEBlingLordMenuItem*} menuItem
 * @param {dispatch_block_t} tapHandlerBlock
 * @return {void}
 */
 ...
 *
 * @param {SEBlingLordMenuItem*} menuItem
 * @param {SEBlingLordViewController*} viewController
 * @return {void}
 */
